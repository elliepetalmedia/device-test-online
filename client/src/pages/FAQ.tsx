          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="double-click">
                <AccordionTrigger className="font-bold text-lg">What is the "Double-Click Fault"?</AccordionTrigger>
              ...
              <AccordionItem value="polling-rate">
                <AccordionTrigger className="font-bold text-lg">What is Polling Rate and why does it matter?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p className="mb-2">
              ...
              <AccordionItem value="jitter">
                <AccordionTrigger className="font-bold text-lg">What does the Jitter Graph show?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p>
          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="ghosting">
                <AccordionTrigger className="font-bold text-lg">What is Ghosting and NKRO?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p className="mb-2">
          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="dead-vs-stuck">
                <AccordionTrigger className="font-bold text-lg">Dead Pixel vs. Stuck Pixel</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p className="mb-2">
              ...
              <AccordionItem value="refresh-rate">
                <AccordionTrigger className="font-bold text-lg">My refresh rate is lower than advertised!</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p className="mb-2">
          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="mic-privacy">
                <AccordionTrigger className="font-bold text-lg">Is my recording saved?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p>
              ...
              <AccordionItem value="permissions">
                <AccordionTrigger className="font-bold text-lg">Why can't I see my camera/mic?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p>
          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="drift">
                <AccordionTrigger className="font-bold text-lg">What is Stick Drift?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p className="mb-2">
              ...
              <AccordionItem value="no-vibration">
                <AccordionTrigger className="font-bold text-lg">Why isn't my controller vibrating?</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  <p>
